...
def parseArguments():
    ...
    return args.f, args.threshold, args.lagtime
...
def main(folder, countThresholds, lagtime):
    ...
    relativeEntropyTranspose = getRelativeEntropy(populations, detailedBalanceComponents, detailedBalanceComponents.T) 
    ...
    relativeEntropySym = getRelativeEntropy(populations, detailedBalanceComponents, detailedBalanceComponentsAverage) 
    print "RelativeEntropy with transpose matrix"
    print "RelativeEntropy with symm matrix"
    print relativeEntropyTranspose
    print relativeEntropySym
    ...
    return frobeniusAvg, relativeEntropyTranspose, relativeEntropySym


if __name__ == '__main__':
    folder, countThresholds, lagtime  = parseArguments()
    main(folder, countThresholds, lagtime) 
