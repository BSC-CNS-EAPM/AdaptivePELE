...
def lengthVsNtrajs(nruns, lagtime, clusters, lengths, ntrajs, outputFilename):
...
def main():
    ...
    with open(outputFilename, 'w') as f: 
        ...
        f.write("Lengths: %s\n"% lengths)
        f.write("Ntrajs: %s\n"% ntrajs)
    results,stdDev,db,stdDb = lengthVsNtrajs(nruns, lagtime, clusters, lengths, ntrajs, outputFilename)
