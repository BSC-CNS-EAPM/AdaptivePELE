...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "AdaptivePELE", 
            "AdaptivePELE/testing"
        ], 
        "name": "AdaptivePELE.testing.utils", 
        "sources": [
            "AdaptivePELE/testing/utils.pyx"
        ]
    }, 
    "module_name": "AdaptivePELE.testing.utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__AdaptivePELE__testing__utils
#define __PYX_HAVE_API__AdaptivePELE__testing__utils
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'AdaptivePELE.testing.utils' */
...
static __Pyx_memviewslice __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "AdaptivePELE.testing.utils"
int __pyx_module_is_main_AdaptivePELE__testing__utils = 0;

/* Implementation of 'AdaptivePELE.testing.utils' */
...
static const char __pyx_k_AdaptivePELE_testing_utils[] = "AdaptivePELE.testing.utils";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static const char __pyx_k_AdaptivePELE_testing_utils_pyx[] = "AdaptivePELE/testing/utils.pyx";
...
static PyObject *__pyx_n_s_AdaptivePELE_testing_utils;
static PyObject *__pyx_kp_s_AdaptivePELE_testing_utils_pyx;
...
static PyObject *__pyx_pf_12AdaptivePELE_7testing_5utils_buildRevTransitionMatrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C); /* proto */
...
/* "AdaptivePELE/testing/utils.pyx":8
...
static __Pyx_memviewslice __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__Pyx_memviewslice __pyx_v_C) {
  ...
  /* "AdaptivePELE/testing/utils.pyx":11
 *     cdef Py_ssize_t sx, sy
 *     cdef double tmp_sum
 *     sx = C.shape[0]             # <<<<<<<<<<<<<<
 *     sy = C.shape[1]
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":12
 *     cdef double tmp_sum
 *     sx = C.shape[0]
 *     sy = C.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double[:] x = np.empty((sy))
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":13
 *     sx = C.shape[0]
 *     sy = C.shape[1]
 *     cdef double[:] x = np.empty((sy))             # <<<<<<<<<<<<<<
 *     for i in range(sx):
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":14
 *     sy = C.shape[1]
 *     cdef double[:] x = np.empty((sy))
 *     for i in range(sx):             # <<<<<<<<<<<<<<
 *         tmp_sum = 0.0
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "AdaptivePELE/testing/utils.pyx":15
 *     cdef double[:] x = np.empty((sy))
 *     for i in range(sx):
 *         tmp_sum = 0.0             # <<<<<<<<<<<<<<
 *         for j in range(sx):
 ...
 */
    ...
    /* "AdaptivePELE/testing/utils.pyx":16
 *     for i in range(sx):
 *         tmp_sum = 0.0
 *         for j in range(sx):             # <<<<<<<<<<<<<<
 *             tmp_sum += C[i, j]
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "AdaptivePELE/testing/utils.pyx":17
 *         tmp_sum = 0.0
 *         for j in range(sx):
 *             tmp_sum += C[i, j]             # <<<<<<<<<<<<<<
 *         x[i] = tmp_sum
 ...
 */
    ...
    /* "AdaptivePELE/testing/utils.pyx":18
 *         for j in range(sx):
 *             tmp_sum += C[i, j]
 *         x[i] = tmp_sum             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":20
 *         x[i] = tmp_sum
 * 
 *     return x             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("AdaptivePELE.testing.utils.sum_rows", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* "AdaptivePELE/testing/utils.pyx":26
 * @cython.wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_12AdaptivePELE_7testing_5utils_1buildRevTransitionMatrix(PyObject *__pyx_self, PyObject *__pyx_arg_C); /*proto*/
static char __pyx_doc_12AdaptivePELE_7testing_5utils_buildRevTransitionMatrix[] = "\n        #Implemented as Prinz paper\n    ";
static PyMethodDef __pyx_mdef_12AdaptivePELE_7testing_5utils_1buildRevTransitionMatrix = {"buildRevTransitionMatrix", (PyCFunction)__pyx_pw_12AdaptivePELE_7testing_5utils_1buildRevTransitionMatrix, METH_O, __pyx_doc_12AdaptivePELE_7testing_5utils_buildRevTransitionMatrix};
static PyObject *__pyx_pw_12AdaptivePELE_7testing_5utils_1buildRevTransitionMatrix(PyObject *__pyx_self, PyObject *__pyx_arg_C) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("AdaptivePELE.testing.utils.buildRevTransitionMatrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12AdaptivePELE_7testing_5utils_buildRevTransitionMatrix(__pyx_self, __pyx_v_C);
...
static PyObject *__pyx_pf_12AdaptivePELE_7testing_5utils_buildRevTransitionMatrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_C) {
  __Pyx_memviewslice __pyx_v_X = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  /* "AdaptivePELE/testing/utils.pyx":32
 *     cdef double[:,:] X, T
 *     cdef Py_ssize_t sx, sy
 *     sx = C.shape[0]             # <<<<<<<<<<<<<<
 *     sy = C.shape[1]
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":33
 *     cdef Py_ssize_t sx, sy
 *     sx = C.shape[0]
 *     sy = C.shape[1]             # <<<<<<<<<<<<<<
 *     X = np.empty((sx, sy))
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":34
 *     sx = C.shape[0]
 *     sy = C.shape[1]
 *     X = np.empty((sx, sy))             # <<<<<<<<<<<<<<
 *     T = np.empty((sx, sy))
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":35
 *     sy = C.shape[1]
 *     X = np.empty((sx, sy))
 *     T = np.empty((sx, sy))             # <<<<<<<<<<<<<<
 *     for k in range(sx):
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":36
 *     X = np.empty((sx, sy))
 *     T = np.empty((sx, sy))
 *     for k in range(sx):             # <<<<<<<<<<<<<<
 *         for ky in range(sy):
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "AdaptivePELE/testing/utils.pyx":37
 *     T = np.empty((sx, sy))
 *     for k in range(sx):
 *         for ky in range(sy):             # <<<<<<<<<<<<<<
 *             X[k, ky]=C[k,ky]+C[ky,k]
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "AdaptivePELE/testing/utils.pyx":38
 *     for k in range(sx):
 *         for ky in range(sy):
 *             X[k, ky]=C[k,ky]+C[ky,k]             # <<<<<<<<<<<<<<
 *             T[k, ky]= 0
 ...
 */
      ...
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_15 * __pyx_v_X.strides[0]) ) + __pyx_t_16 * __pyx_v_X.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_11 * __pyx_v_C.strides[0]) ) + __pyx_t_12 * __pyx_v_C.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_C.data + __pyx_t_13 * __pyx_v_C.strides[0]) ) + __pyx_t_14 * __pyx_v_C.strides[1]) ))));
      ...
      /* "AdaptivePELE/testing/utils.pyx":39
 *         for ky in range(sy):
 *             X[k, ky]=C[k,ky]+C[ky,k]
 *             T[k, ky]= 0             # <<<<<<<<<<<<<<
 *     cdef double[:] x, c
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":41
 *             T[k, ky]= 0
 *     cdef double[:] x, c
 *     x = sum_rows(X)             # <<<<<<<<<<<<<<
 *     c = sum_rows(C)
 ...
 */
  __pyx_t_19 = __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__pyx_v_X); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 41, __pyx_L1_error)
  __pyx_v_x = __pyx_t_19;
  __pyx_t_19.memview = NULL;
  __pyx_t_19.data = NULL;

  /* "AdaptivePELE/testing/utils.pyx":42
 *     cdef double[:] x, c
 *     x = sum_rows(X)
 *     c = sum_rows(C)             # <<<<<<<<<<<<<<
 *     cdef int iterations = 1000
 *     cdef int it, i, j
 */
  __pyx_t_19 = __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__pyx_v_C); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 42, __pyx_L1_error)
  __pyx_v_c = __pyx_t_19;
  __pyx_t_19.memview = NULL;
  __pyx_t_19.data = NULL;

  /* "AdaptivePELE/testing/utils.pyx":43
 *     x = sum_rows(X)
 *     c = sum_rows(C)
 *     cdef int iterations = 1000             # <<<<<<<<<<<<<<
 *     cdef int it, i, j
 ...
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":47
 *     cdef double a, b, z, tmp, tmp2, tmp3
 * 
 ...
 */
  ...
  for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_20; __pyx_t_21+=1) {
    ...
    /* "AdaptivePELE/testing/utils.pyx":49
 *     for it in range(iterations):
 *         # if it != 0 and it % 10 == 0: print it
 *         for i in range(sx):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_22 = 0; __pyx_t_22 < __pyx_t_7; __pyx_t_22+=1) {
      ...
      /* "AdaptivePELE/testing/utils.pyx":50
 *         # if it != 0 and it % 10 == 0: print it
 *         for i in range(sx):
 *             X[i,i] = C[i,i] * (x[i] - X[i,i]) / (c[i] - C[i,i])             # <<<<<<<<<<<<<<
 *         x = sum_rows(X)
 ...
 */
    ...
    /* "AdaptivePELE/testing/utils.pyx":51
 *         for i in range(sx):
 *             X[i,i] = C[i,i] * (x[i] - X[i,i]) / (c[i] - C[i,i])
 *         x = sum_rows(X)             # <<<<<<<<<<<<<<
 *         for i in range(sx - 1):
 ...
 */
    __pyx_t_19 = __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__pyx_v_X); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 51, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_x, 1);
    __pyx_v_x = __pyx_t_19;
    __pyx_t_19.memview = NULL;
    __pyx_t_19.data = NULL;

    /* "AdaptivePELE/testing/utils.pyx":52
 *             X[i,i] = C[i,i] * (x[i] - X[i,i]) / (c[i] - C[i,i])
 *         x = sum_rows(X)
 *         for i in range(sx - 1):             # <<<<<<<<<<<<<<
 *             for j in range(i + 1, sx):
 ...
 */
    ...
    for (__pyx_t_22 = 0; __pyx_t_22 < __pyx_t_7; __pyx_t_22+=1) {
      ...
      /* "AdaptivePELE/testing/utils.pyx":53
 *         x = sum_rows(X)
 *         for i in range(sx - 1):
 *             for j in range(i + 1, sx):             # <<<<<<<<<<<<<<
 *                 a = c[i] - C[i,j] + c[j] - C[j,i]
 ...
 */
      ...
      for (__pyx_t_33 = (__pyx_v_i + 1); __pyx_t_33 < __pyx_t_8; __pyx_t_33+=1) {
        ...
        /* "AdaptivePELE/testing/utils.pyx":54
 *         for i in range(sx - 1):
 *             for j in range(i + 1, sx):
 *                 a = c[i] - C[i,j] + c[j] - C[j,i]             # <<<<<<<<<<<<<<
 *                 b = c[i]*(x[j]-X[i,j]) + c[j]*(x[i] - X[i,j]) -(C[i,j] + C[j,i])*(x[i] + x[j] - 2*X[i,j])
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":55
 *             for j in range(i + 1, sx):
 *                 a = c[i] - C[i,j] + c[j] - C[j,i]
 *                 b = c[i]*(x[j]-X[i,j]) + c[j]*(x[i] - X[i,j]) -(C[i,j] + C[j,i])*(x[i] + x[j] - 2*X[i,j])             # <<<<<<<<<<<<<<
 *                 z = -(C[i,j] + C[j,i])*(x[i] - X[i,j])*(x[j] - X[i,j])
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":56
 *                 a = c[i] - C[i,j] + c[j] - C[j,i]
 *                 b = c[i]*(x[j]-X[i,j]) + c[j]*(x[i] - X[i,j]) -(C[i,j] + C[j,i])*(x[i] + x[j] - 2*X[i,j])
 *                 z = -(C[i,j] + C[j,i])*(x[i] - X[i,j])*(x[j] - X[i,j])             # <<<<<<<<<<<<<<
 *                 tmp = b**2 - 4*a*z
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":57
 *                 b = c[i]*(x[j]-X[i,j]) + c[j]*(x[i] - X[i,j]) -(C[i,j] + C[j,i])*(x[i] + x[j] - 2*X[i,j])
 *                 z = -(C[i,j] + C[j,i])*(x[i] - X[i,j])*(x[j] - X[i,j])
 *                 tmp = b**2 - 4*a*z             # <<<<<<<<<<<<<<
 *                 tmp2 = 2*a
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":58
 *                 z = -(C[i,j] + C[j,i])*(x[i] - X[i,j])*(x[j] - X[i,j])
 *                 tmp = b**2 - 4*a*z
 *                 tmp2 = 2*a             # <<<<<<<<<<<<<<
 *                 tmp3 = sqrt(tmp)
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":59
 *                 tmp = b**2 - 4*a*z
 *                 tmp2 = 2*a
 *                 tmp3 = sqrt(tmp)             # <<<<<<<<<<<<<<
 *                 X[j,i] = (-b+tmp3)/tmp2
 ...
 */
        ...
        /* "AdaptivePELE/testing/utils.pyx":60
 *                 tmp2 = 2*a
 *                 tmp3 = sqrt(tmp)
 *                 X[j,i] = (-b+tmp3)/tmp2             # <<<<<<<<<<<<<<
 *                 X[i,j] = X[j,i]
 ...
 */
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_66 * __pyx_v_X.strides[0]) ) + __pyx_t_67 * __pyx_v_X.strides[1]) )) = (((-__pyx_v_b) + __pyx_v_tmp3) / __pyx_v_tmp2);
        ...
        /* "AdaptivePELE/testing/utils.pyx":61
 *                 tmp3 = sqrt(tmp)
 *                 X[j,i] = (-b+tmp3)/tmp2
 *                 X[i,j] = X[j,i]             # <<<<<<<<<<<<<<
 *         x = sum_rows(X)
 ...
 */
    ...
    /* "AdaptivePELE/testing/utils.pyx":62
 *                 X[j,i] = (-b+tmp3)/tmp2
 *                 X[i,j] = X[j,i]
 *         x = sum_rows(X)             # <<<<<<<<<<<<<<
 * 
 *     for i in range(sx):
 */
    __pyx_t_19 = __pyx_f_12AdaptivePELE_7testing_5utils_sum_rows(__pyx_v_X); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 62, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_x, 1);
    __pyx_v_x = __pyx_t_19;
    __pyx_t_19.memview = NULL;
    __pyx_t_19.data = NULL;
  ...
  /* "AdaptivePELE/testing/utils.pyx":64
 *         x = sum_rows(X)
 * 
 *     for i in range(sx):             # <<<<<<<<<<<<<<
 *         for j in range(sx):
 ...
 */
  ...
  for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_7; __pyx_t_20+=1) {
    ...
    /* "AdaptivePELE/testing/utils.pyx":65
 * 
 *     for i in range(sx):
 *         for j in range(sx):             # <<<<<<<<<<<<<<
 *             T[i,j] = X[i,j]/x[i]
 ...
 */
    ...
    for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_8; __pyx_t_21+=1) {
      ...
      /* "AdaptivePELE/testing/utils.pyx":66
 *     for i in range(sx):
 *         for j in range(sx):
 *             T[i,j] = X[i,j]/x[i]             # <<<<<<<<<<<<<<
 *     return np.array(T)
 */
  ...
  /* "AdaptivePELE/testing/utils.pyx":67
 *         for j in range(sx):
 *             T[i,j] = X[i,j]/x[i]
 *     return np.array(T)             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "AdaptivePELE.testing.utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "AdaptivePELE.testing.utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "AdaptivePELE.testing.utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "AdaptivePELE.testing.utils._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_AdaptivePELE_testing_utils, __pyx_k_AdaptivePELE_testing_utils, sizeof(__pyx_k_AdaptivePELE_testing_utils), 0, 0, 1, 1},
  {&__pyx_kp_s_AdaptivePELE_testing_utils_pyx, __pyx_k_AdaptivePELE_testing_utils_pyx, sizeof(__pyx_k_AdaptivePELE_testing_utils_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(1, 0, 20, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_AdaptivePELE_testing_utils_pyx, __pyx_n_s_buildRevTransitionMatrix, 26, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 26, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_AdaptivePELE__testing__utils) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "AdaptivePELE.testing.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "AdaptivePELE.testing.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "AdaptivePELE/testing/utils.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport cython
 * cimport numpy as np
 */
 ...
 *         #Implemented as Prinz paper
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_12AdaptivePELE_7testing_5utils_1buildRevTransitionMatrix, NULL, __pyx_n_s_AdaptivePELE_testing_utils); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init AdaptivePELE.testing.utils", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init AdaptivePELE.testing.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
