...
cdef class PDB:
    ...
    def join_PDB_lines(self, list topology, np.ndarray[float, ndim=2] frame):
        ...
        for i in range(natoms):
            line = topology[i]
            if prevLine is not None and (prevLine[21] != line[21] or (prevLine[22:26] != line[22:26] and (u"HOH" == line[17:20] or u"HOH" == prevLine[17:20])) or (prevLine[0:4] == "ATOM" and line[0:6] == "HETATM") or (prevLine[0:6] == "HETATM" and line[0:6] == "HETATM" and (prevLine[22:26] != line[22:26])) or (int(line[22:27]) -  int(prevLine[22:27]) > 1)):
                pdb.append(u"TER\n")
